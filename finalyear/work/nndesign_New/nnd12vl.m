...
if (strcmp(cmd,'down') && (fig) && (nargin == 1))  || strcmp(cmd,'lr') ...
         || strcmp(cmd,'inc') || strcmp(cmd,'dec')

  if strcmp(cmd,'lr') || strcmp(cmd,'inc') || strcmp(cmd,'dec')
  ...
  if (x > xlim(1) & x < xlim(2) & y > ylim(1) & y < ylim(2))
    ...
    for i=2:(ep+1)
      ...
      new_A1 = nndlogsig(new_W1*P+new_b1*ones(1,Q));
      new_A2 = nndlogsig(new_W2*A1+new_b2*ones(1,Q));
      new_E = T-new_A2;
  ...
  set(inc_bar,'enable','on');
  set(dec_bar,'enable','on');
