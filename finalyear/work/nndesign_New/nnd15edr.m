function nnd15edr(cmd,arg1,arg2,arg3)
%NND15EDR Effects of decay rate demonstration.
...
elseif strcmp(cmd,'init') & (~fig)
  ...
  % NEW DEMO FIGURE
  fig = nndemof2(me,'DESIGN','Effects of Decay Rate','','Chapter 15');
  ...
  for i=1:30,
    ...
    a = feval('nndhardlim',1*(rem(i,2)==0)+w*1-0.5);
    w = w+lr*a*1-dr*w;
    wtot=[wtot w];
  end
