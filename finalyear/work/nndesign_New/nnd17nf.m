...
elseif strcmp(cmd,'f_motion') & (fig)
  ...
  % ODJ 9/16/08 Change to solve erasing of function line as mouse moves
  set(func_line,'color',ltyell);
  set(func_line,'color',nndkblue)
  %set(func_line,'color',nndkblue,'xdata',get(func_line,'XData'),'ydata',get(func_line,'YData'))
