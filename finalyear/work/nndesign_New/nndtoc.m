...
elseif strcmp(cmd,'init') & (~fig)
  ...
  set(nnsfo('b7','18-21'),...
    'callback','nndtoc(''menus'',[18 19 20 21])')
...
elseif strcmp(cmd,'chap') & (nargin == 2)
  ...
  elseif arg1 == 13
    res1 = 'Generalization';
    res2 = ['Early Stopping|Regularization|Bayesian Regularization|Early Stopping\Regularization'];
    res3 = str2mat('nnd13es','nnd13reg','nnd13breg','nnd13esr');
  elseif arg1 == 14
    res1 = 'Dynamic Networks';
    res2 = ['FIR Network|IIR Network|Dynamic Derivatives'];
    res3 = str2mat('nnd14fir','nnd14iir','nnd14dynd');
  elseif arg1 == 15
    res1 = 'Associative Learning';
    res2 = 'Unsupervised Hebb|Effects of Decay Rate|Hebb with Decay|Graphical Instar|Instar|Outstar';
    res3 = str2mat('nnd15uh','nnd15edr','nnd15hd','nnd15gis','nnd15is','nnd15os');
  elseif arg1 == 16
    res1 = 'Competitive Networks';
    res2 = ['Competitive Classification|Competitive Learning|1-D Feature Map|',...
            '2-D Feature Map|LVQ1|LVQ2'];
    res3 = str2mat('nnd16cc','nnd16cl','nnd16fm1','nnd16fm2','nnd16lv1','nnd16lv2');
  elseif arg1 == 17
    res1 = 'Radial Basis Function';
    res2 = ['Network Function|Pattern Classification|Linear Least Squares|',...
            'Orthogonal Least Squares|Nonlinear Optimization'];
    res3 = str2mat('nnd17nf','nnd17pc','nnd17lls','nnd17ols','nnd17no');
  elseif arg1 == 18
    res1 = 'Grossberg Network';
    res2 = ['Leaky Integrator|Shunting Network|Grossberg Layer 1|', ...
            'Grossberg Layer 2|Adaptive Weights'];
    res3 = str2mat('nnd18li','nnd18sn','nnd18gl1','nnd18gl2','nnd18aw');
  elseif arg1 == 19
    res1 = 'Adaptive Resonance Theory';
    res2 = 'ART1 Layer 1|ART1 Layer 2|Orienting Subsystem|ART1 Algorithm';
    res3 = str2mat('nnd19al1','nnd19al2','nnd19os','nnd19a1');
  elseif arg1 == 20
    res1 = 'Stability';
